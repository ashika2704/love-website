        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-amber-900 py-8 px-4 relative flex flex-col items-center">
            <div className="max-w-6xl w-full">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 mt-3" style={{ fontFamily: 'var(--font-body)' }}>
                        Fights & Understanding 🤝
                    </h1>

                    <p className="text-sm md:text-lg text-amber-100/80 italic max-w-3xl mx-auto leading-relaxed" style={{ fontFamily: 'var(--font-body)' }}>
